function TVInformation({ originalName, originalCountry, status, networks }) {
  return (
    <div className="flex-1 text-[1.2vw]">
      <p className="mb-4 text-[2vw] font-bold">TVInformation</p>
        ...
        <div className="">
          ...
          <p>
            {networks?.map((i) => (
              <img
                key={i.id}
                src={`https://media.themoviedb.org/t/p/h30${i.logo_path}`}
              />
            ))}
          </p>
        </div>
